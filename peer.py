...
class Peer:
    ...
    #COneect to peer new connection
    ...
    #Checks whcih peers ahve whcih file
...
if __name__ == "__main__":
    try:
        ...
        print("0|cls: Close the connection with serevr")
        print("1|conn: connect to server")
        ...
        while True:
            ...
            if inp == "conn" or inp == '1':
                if not connected:
                    ...
                    print("peer is already connected to server")
